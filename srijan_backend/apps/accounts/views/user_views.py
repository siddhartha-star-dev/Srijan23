...
from srijan_backend.apps.accounts.models.user_models import User
from srijan_backend.apps.accounts.serializers.user_serializers import (
    ProfileCreateUpdateSerializer,
    UserInfoSerializer,
)
from srijan_backend.apps.common.custom_auto_schema import CustomAutoSchema
from srijan_backend.docs.user_docs import ProfileUpdate
